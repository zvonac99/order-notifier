...
use EliasHaeussler\SSE\Exception\StreamIsInactive;
use EliasHaeussler\SSE\Stream\Emitter\Emitter;
use EliasHaeussler\SSE\Stream\Emitter\RealtimeEmitter;
...
final class SelfEmittingEventStream implements EventStream
{
    ...
    public static function create(
        ?string $id = null,
        int $retry = 50,
        Emitter $emitter = new RealtimeEmitter(),
    ): self {
    ...
    public static function canHandle(ServerRequestInterface $request): bool
    {
